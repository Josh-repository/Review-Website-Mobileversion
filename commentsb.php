...
<body>
	...
	if (isset($_SESSION['reg_character'])) {
		...
		$user_details_query = mysqli_query($con, "SELECT * FROM food WHERE city='$city'");
	...
	<!-- Load comments -->
		<?php 
		$get_comments=mysqli_query($con,"SELECT * FROM comments WHERE  postb='$post_id' ORDER BY sno ASC");
