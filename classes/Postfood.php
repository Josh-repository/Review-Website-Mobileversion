...
class Postfood
{
	...
	public function loadPostsFriends($data, $limit) {
		...
		$data_query = mysqli_query($this->con, "SELECT * FROM food WHERE city='$city' AND deleted='no' ORDER BY sno DESC");
		if(mysqli_num_rows($data_query) > 0) {
			...
			while($row = mysqli_fetch_array($data_query)) {
				...
				?>
					...
					$str .= "
					<div class='outer'>
					<div class='title'><p><b>Food:</b>$id</p></div>
					<div class='main_column4 column4'>
						<div class='status_post' >
							<b>Name of the city:</b>$don
							<br>
							<b>Name of the restaurant/hotel:</b>$name
							<br>
							<b>Name of the location:</b>$place
							<br>
							<b>Type of food:</b>$type
							<br>
